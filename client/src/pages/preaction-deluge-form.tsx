...
import { ArrowLeft, ArrowRight, CheckCircle, Save, AlertTriangle, Zap, Activity, PenTool } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-foreground mb-2" data-testid="title-preaction-deluge-form">
...
{(() => {
                    ...
                    {sections.findIndex(s => s.id === currentSection) === sections.length - 1 && (
                      <FormActions
                        ...
                        formTitle="Inspeção de Sistema Pré-Ação e Dilúvio"
                        signatures={{
                        ...
                        onValidateForm={() => {
                          ...
                          if (!values.systemType) errors.push("Tipo de Sistema é obrigatório");
