    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border border-border rounded-lg p-4 bg-accent/50">
          <div className="flex items-center justify-between mb-2">
            <h5 className="font-medium text-accent-foreground">Sistemas Molhados</h5>
        ...
        <div className="border border-border rounded-lg p-4 bg-accent/50">
          <div className="flex items-center justify-between mb-2">
            <h5 className="font-medium text-accent-foreground">Sistemas Secos</h5>
        ...
        <div className="border border-border rounded-lg p-4 bg-accent/50">
          <div className="flex items-center justify-between mb-2">
            <h5 className="font-medium text-accent-foreground">Colunas de Incêndio</h5>
        ...
        <div className="border border-border rounded-lg p-4 bg-accent/50">
          <div className="flex items-center justify-between mb-2">
            <h5 className="font-medium text-accent-foreground">Bombas de Incêndio</h5>
          ...
          />
          <p className="text-sm text-muted-foreground">Bomba elétrica</p>
        </div>
      </div>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Condições especiais, modificações recentes ou observações relevantes"
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="extreme">Clima Extremo</SelectItem>
              </SelectContent>
            </Select>
          </div>
